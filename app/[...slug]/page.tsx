  ...
  return (
    <div className="text-center py-16">
      <div className="bg-primary-900 border border-primary-800 rounded-lg p-12">
        ...
        <p className="text-stone-400 mb-2">We couldn&#39;t find any content at this path.</p>
        <p className="text-sm text-stone-500">Path: {path}</p>
      </div>
    </div>
  )
}
          ...
          <ErrorBoundary>
            <article className="bg-primary-900 border border-primary-800 rounded-lg shadow-sm overflow-hidden">
              ...
              <div className="p-6 md:p-8">
                ...
                <div className="prose prose-invert prose-headings:text-white prose-p:text-stone-300 prose-a:text-stone-300 prose-strong:text-white prose-sm sm:prose lg:prose-lg max-w-none" dangerouslySetInnerHTML={{ __html: bodyHtml }} />
              </div>
            </article>
          </ErrorBoundary>
        </main>
